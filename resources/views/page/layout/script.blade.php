...
<!-- datepicker -->
<script type="text/javascript" src="{{ asset('js/datepicker/bootstrap-datetimepicker.min.js') }}"></script>

<!-- open menu -->
<script type="text/javascript" src="{{ asset('js/book/modernizr.custom.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/book/bookblock.min.js') }}"></script>
