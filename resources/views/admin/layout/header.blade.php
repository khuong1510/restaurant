...
<link href="{{ asset('assets/layouts/layout2/css/font-page.css') }}" rel="stylesheet" type="text/css" />
...
<link href="{{ asset('assets/restaurant-custom.css') }}" rel="stylesheet" type="text/css" />
